 ...
 *
 *  Author :
 *  Ulugbek Ergashev (uergash1@binghamton.edu) *  State University of New York, Binghamton
 */
...
typedef struct CPU_Stage
{
  ...
  int z_flag;           // Z flag for branch instruction
...
typedef struct APEX_CPU
{
  ...
  /* Flag for STORE that shows whether source register 1 is valid */
  int store_rs1_valid;
